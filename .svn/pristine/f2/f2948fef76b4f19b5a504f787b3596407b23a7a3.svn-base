...
<body>
	<div class="container">
		<div id=main_div>
			<span id="main_text">水道代, 電気代 修正</span><span class="red_text">*下の必須入力事項をすべて入力してください。</span>
		</div>
		<form method="post" action="subModify.do">
			<div class="text_div">
				<span class="text_id">号室</span> <span><input type="text"
					class="text_read"  name="no" value="${sub.no }" readonly /></span>
			</div>

			<div class="text_div">
				<span class="red_text">*</span><span class="text_id">水道代</span> <span><input type="text"
					class="input_text"  name="water_ind" value="${sub.water_ind }" /></span>
			</div>

			<div class="text_div">
				<span class="red_text">*</span><span class="text_id">基本電気代</span> <span><input type="text"
					class="input_text"  name="ele_basic" value="${sub.ele_basic }" /></span>
			</div>

			<div class="text_div">
				<span class="red_text">*</span><span class="text_id">個人電気代</span> <span>
			...
			<div id="btn_div">
				<input class="submit_btn" type="hidden"
					...
					class="submit_btn" type="button" value="戻る"
					onclick="location.href = 'subList.do'" /> <input
					class="submit_btn" type="submit" value="修正" />
			</div>
		</form>
	</div>
</body>
